...
class Tests {
    ...
    fun circleInside() {
        ...
        assertFalse(circleInside(-999.8811456923586, -632.0, 0.010000000000000222, -999.3669620994584, -999.4681210986232, 0.1438416070956997))
        assertFalse(circleInside(-632.0, -632.0, 0.010000000000000222, -1000.0, -632.0, 0.22414420285204584))
        assertFalse(circleInside(-999.7151526686965, -999.2210882863862, 0.34776916535813307, -1000.0, -632.0, 0.01))
        assertTrue(circleInside(-1000.0, -1000.0, 0.010000000000000222, -999.491385596336, -999.4210581202409, 47.72046349852233))
    }
    ...
    fun brickPasses() {
        ...
        assertFalse(brickPasses(20, 10, 9, 8, 9))
        assertFalse(brickPasses(4, 8, 8, 7, 7))
    }
}